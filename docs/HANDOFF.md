...
Poslední update: **2026-08-05** (odolnost volání BC API — **nasazeno a ověřeno živě**) · předtím 2026-07-24 (Push #77 auto-smazání dat odebrané firmy + manažerská zpráva trend max 10 dní newest-first — **deploy pending**) · předtím Push #76 / `ee9a75e` · repo `Anamax443/BC_Telemetry`.
